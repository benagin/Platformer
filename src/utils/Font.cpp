...
Font::
Font(const std::string& _filename, int _height, int _scale, int _ascent,
    int _descent, int _lineGap): m_height(_height), m_scale(_scale),
    m_ascent(_ascent), m_descent(_descent), m_lineGap(_lineGap) {
